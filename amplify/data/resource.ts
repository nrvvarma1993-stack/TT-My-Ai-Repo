...
const schema = a.schema({
  Project: a.model({
    ...
    completed: a.integer(),
    ahtImpact: a.float(), // Changed from string to float - store as decimal (e.g., 0, 5.0)
    costSaving: a.float(), // e.g., 0.00, 360000.00
    qualityImpact: a.float(), // Changed from string to float - store as decimal (e.g., 0.0, 2.5)
